...
[![NPM version](https://img.shields.io/npm/v/carbonaware.svg)](https://npmjs.org/package/carbonaware) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/carbonaware)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/carbonaware-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install carbonaware`
...
```ts
import CarbonawareScheduler from 'npm:carbonaware';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/carbonaware-typescript/issues) with questions, bugs, or suggestions.
